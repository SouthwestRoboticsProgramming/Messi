...
public enum GamePiece {
    CONE(NTData.INTAKE_CONE_IN_SPEED, NTData.INTAKE_CONE_OUT_SPEED, NTData.INTAKE_CONE_HOLD),
    CUBE(NTData.INTAKE_CUBE_IN_SPEED, NTData.INTAKE_CUBE_OUT_SPEED, NTData.INTAKE_CUBE_HOLD);
    ...
    GamePiece(
            NTEntry<Double> intakeSpeed, NTEntry<Double> outtakeSpeed, NTEntry<Double> holdSpeed) {
