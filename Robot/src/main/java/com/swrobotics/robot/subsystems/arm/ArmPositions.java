...
public final class ArmPositions {
    ...
    private static final ArmPosition UNSET_DEFAULT =
            new ArmPose(CCWAngle.deg(90), CCWAngle.deg(-80), Angle.ZERO).toPosition();

    public static final ArmPosition.NT DEFAULT =
            new ArmPosition.NT(
                    "Arm/Positions/Default",
                    new ArmPose(CCWAngle.deg(90), CCWAngle.deg(-90), CCWAngle.deg(-90))
                            .toPosition(),
                    false);
    ...
    public static final PositionSet CONE =
            new PositionSet(
                    new ArmPosition.NT(
                            "Arm/Positions/Cone/Back/Score High",
                            -0.906460,
                            1.234174,
                            CCWAngle.deg(-194.142015),
                            true),
                    new FrontBackPair(
                            null,
                            new ArmPosition.NT(
                                    "Arm/Positions/Cone/Back/Score Mid",
                                    -0.619149,
                                    1.150590,
                                    CCWAngle.deg(-189.259830),
                                    true)),
                    new FrontBackPair(
                            null,
                            //                            new ArmPosition.NT(
                            //                                    "Arm/Positions/Cone/Front/Floor
                            // Pickup",
                            //                                    0.797765, 0.263012,
                            // CCWAngle.deg(-31.995325), false),
                            new ArmPosition.NT(
                                    "Arm/Positions/Cone/Back/Floor Pickup",
                                    -0.497925,
                                    0.122659,
                                    CCWAngle.deg(-143.687955),
                                    false)),
                    new FrontBackPair(null, null),
                    //                            new ArmPosition.NT(
                    ...
                    new FrontBackPair(
                            ...
                            new ArmPosition.NT(
                                    ...
                                    -0.472302,
                                    1.280790,
                                    CCWAngle.deg(-186.306754),
                                    false)));
    public static final PositionSet CUBE =
            new PositionSet(
                    new ArmPosition.NT(
                            "Arm/Positions/Cube/Front/Score High",
                            1.133248,
                            1.048364,
                            CCWAngle.deg(109.709461),
                            true),
                    new FrontBackPair(
                            new ArmPosition.NT(
                                    "Arm/Positions/Cube/Front/Score Mid",
                                    0.956374,
                                    0.791880,
                                    CCWAngle.deg(67.709953),
                                    true),
                            new ArmPosition.NT(
                                    "Arm/Positions/Cube/Back/Score Mid",
                                    -0.704469,
                                    1.068582,
                                    CCWAngle.deg(-52.708538),
                                    true)),
                    new FrontBackPair(
                            new ArmPosition.NT(
                                    ...
                                    0.599123,
                                    0.003825,
                                    CCWAngle.deg(49.571949),
                                    false),
                            new ArmPosition.NT(
                                    "Arm/Positions/Cube/Back/Floor Pickup",
                                    -0.780257,
                                    0.089131,
                                    CCWAngle.deg(-16.454774),
                                    true)),
                    new FrontBackPair(null, null),
                    //                            new ArmPosition.NT(
                    ...
                    new FrontBackPair(
                            new ArmPosition.NT(
                                    ...
                                    0.729392,
                                    0.959242,
                                    CCWAngle.deg(64.770436),
                                    false),
                            new ArmPosition.NT(
                                    "Arm/Positions/Cube/Back/Substation Pickup",
                                    -0.462597,
                                    1.248891,
                                    CCWAngle.deg(-61.787313),
                                    false)));
    public static final FrontBackPair DOWNED_CONE_FLOOR_PICKUP = new FrontBackPair(null, null);
    ...
    public static final class FrontBackPair {
        ...
        public FrontBackPair(ArmPosition.NT front, ArmPosition.NT back) {
            ...
            if (front != null) front.setPersistent();
            if (back != null) back.setPersistent();
        }
    }
    ...
    public static final class PositionSet {
        ...
        public PositionSet(
            ...
            if (scoreHigh != null) scoreHigh.setPersistent();
        }
    }
}
